...
urlpatterns = [
    ...
    url(r'^pledgerewards/(?P<project_id>\d+)/p(?P<P_R_id>\d+)/delete/$', DeletePledgeRewardsView.as_view(), kwargs=dict(mode="pledge"), name='delete_pledge'),

    url(r'^pledgerewards/(?P<project_id>\d+)/r(?P<P_R_id>\d+)/delete/$', DeletePledgeRewardsView.as_view(), kwargs=dict(mode="reward"), name='delete_reward'),

    url(r'^details/(?P<project_id>\d+)/$', ProjectDetailsView.as_view(), name='details'),

    url(r'^details/(?P<project_id>\d+)/add_pledge/(?P<pledge_id>\d+)/$', ProjectDetailsView.as_view(), name='add_pledge'),
